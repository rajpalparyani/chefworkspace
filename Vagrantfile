...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "rajpalparyani-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/nimbo"
  #   chef.validation_client_name = "nimbo-validator"
  #   chef.validation_key_path = ".chef/nimbo-validator.pem"
  # end
end
